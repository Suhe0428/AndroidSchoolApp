...
public class Community {
    ...
    public int community_item_content_img;

    public Community() {
    }

    public Community(String community_item_source, int community_item_source_img, String community_item_content, int community_item_content_img) {
