...
public class LoginActivity extends AppCompatActivity {
    ...
    public void doPost(final String tel, final String password){
        ...
        Request request = builder.get().url(BaseUrl.BASE_URL+"login").post(requestBody).build();
        //3.将Request封装为Call
     ...
     * 记住登录
     * 1.写入登录信息*/
    public void writeLogin(String id,String phone,String password){
        /*保存信息*/
    ...
    /*3.查找用户*/
    public void doHttpGetUser(String user_phone){
        OkHttpClient okHttpClient=new OkHttpClient();
        ...
        okHttpClient.newCall(request).enqueue(new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                writeLogin(Integer.toString(user.getUser_id()),user.getUser_phone(),user.getUser_password());
            }
        });
    }
