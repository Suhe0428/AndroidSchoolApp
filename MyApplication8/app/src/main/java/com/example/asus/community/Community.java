...
public class Community {
    private String community_item_source;//发帖人名称
    private int community_item_source_img;//发帖人头像
    private String community_item_content;//帖子文字内容
    private int community_item_content_img;//帖子图片内容
    private boolean community_item_isfav;//是否点赞
    private int community_item_fav_num;//点赞数
