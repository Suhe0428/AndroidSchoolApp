...
public class Goods {
    ...
    private String goods_seller_id;//卖家账号
    ...
    public Goods(int goods_id, String goods_name, String goods_info, int goods_target_id, String goods_seller_id, double goods_price, String goods_place, String goods_image) {
