...
public class CommunityAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (!community.getCommunity_item_isfav()) {//初始化为未点赞
            viewHolder.imageButton_fav.setImageDrawable(context.getResources().getDrawable(R.drawable.ic_community_favorite_border));
        } else {
            viewHolder.imageButton_fav.setImageDrawable(context.getResources().getDrawable(R.drawable.ic_community_favorite));
        }
