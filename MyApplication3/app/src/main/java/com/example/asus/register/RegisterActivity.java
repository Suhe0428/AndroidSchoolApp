...
public class RegisterActivity extends AppCompatActivity {
    ...
    public static final String BaseUrl="http://192.168.0.103:8080/MyAppServer/AppServlet/";
    ...
    public void doPost(String tel,String password){
        ...
        Request request = builder.get().url(BaseUrl+"register").post(requestBody).build();
        //3.将Request封装为Call
