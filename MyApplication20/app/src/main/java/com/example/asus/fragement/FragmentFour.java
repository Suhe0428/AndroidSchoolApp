...
import com.example.asus.my.password.EditPasswordActivity;
...
public class FragmentFour extends Fragment {
    ...
    private TextView textView_editPassword;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        textView_editPassword=view.findViewById(R.id.textView_editPassword);
        textView_editPassword.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
