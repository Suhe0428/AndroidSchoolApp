...
public class GoodsAdapter extends RecyclerView.Adapter<GoodsAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull GoodsAdapter.ViewHolder holder, int position) {
        Goods goods = goodsList.get(position);
        //设置资源图片
        doHttpGetImg(holder.handler,holder.imageView_goodsImage, goods.getGoods_image());
        //设置文本
    ...
    public void doHttpGetImg(final Handler handler, final ImageView imageView, String img_name) {
