...
import com.example.asus.community.Post;
import com.example.asus.community.PostAdapter;
...
public class FragmentTwo extends Fragment {
        ...
        okHttpClient.newCall(request).enqueue(new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                for (Post post:postListFromJson){
                    doPostGetUserName(post,post.getPost_source_phone());
                    postList.add(post);
                }
            }
        });
    ...
    public void  doPostGetUserName(final Post post, String post_source_phone){
        //1.okHttpClient
        OkHttpClient okHttpClient = new OkHttpClient();
        //2.构造Request
        FormBody requestBody = new FormBody.Builder()
                .add("user_phone", post_source_phone).build();
